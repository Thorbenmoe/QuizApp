...
let AUDIO_FAILED = new Audio('sound/wrong.wav');
...
function init() {
    ...
    document.getElementById('right_all').innerHTML = `${questions.length}`;
...
function showQuestoins() {
    ...
    if (currentQuestion >= questions.length) {
        quest_now = 5;
        document.getElementById('progress-label').innerHTML = `${percent} %`;
        document.getElementById('progress-label').style.width = `${percent}%`;
        document.getElementById('progress-label').style.background = `#4caf50`;
        document.getElementById('endscreen').style = '';
        document.getElementById('questionbody').style = 'display:none';
    } else {
        document.getElementById('progress-label').innerHTML = `${percent} %`;
        document.getElementById('progress-label').style.width = `${percent}%`;
        console.log('Fortscrhitt:', percent);
...
function restart() {
    ...
    document.getElementById('questionbody').style = ''; //question body wird wieder angezeigt
    document.getElementById('header-img').src = 'img/img1.jpg';
    right_answerd = 0;
    currentQuestion = 0;
    quest_now = 1;
    percent = 0;
